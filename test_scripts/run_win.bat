...
Rem .\test_scripts\run_winn.bat .\scripts\dist\WatermarkRemover.exe 20
Rem .\test_scripts\run_winn.bat .\scripts\dist\tt.exe 2
Rem .\test_scripts\run_winn.bat .\scripts\dist\5min.exe 5